...
con = sqlite3.Connection('hm_proj3.db')
cur = con.cursor()
cur.execute("create table if not exists hoteld(t_r number,r_r number,t_s number)")
cur.execute("create table if not exists roomd(rn number primary key,beds number,ac varchar(10),tv varchar(10),internet varchar(10),price number(10),rstatus varchar(10))")

#pmethod=0
#rstatus extra column
#cur.execute("alter table roomd add column rstatus varchar(10)")
# cur.execute(
#    "insert into roomd values(19,1,'Yes','Yes','Yes',1000,'Unreserved')")
# cur.execute(
#    "insert into roomd values(20,1,'Yes','No','Yes',1000,'Unreserved')")
# cur.execute("insert into roomd values(1,1,'Yes','No','Yes',1000,'Unreserved')")
# cur.execute("insert into roomd values(2,1,'Yes','No','Yes',1000,'Unreserved')")
# cur.execute("insert into roomd values(3,1,'Yes','No','Yes',1000,'Unreserved')")
# cur.execute("insert into roomd values(4,1,'Yes','Yes','No',1000,'Unreserved')")
# cur.execute("insert into roomd values(5,1,'Yes','Yes','No',1000,'Unreserved')")
# cur.execute("insert into roomd values(6,1,'Yes','Yes','No',1000,'Unreserved')")
# cur.execute("insert into roomd values(7,1,'Yes','Yes','No',1000,'Unreserved')")
# cur.execute("insert into roomd values(8,1,'No','Yes','Yes',1000,'Unreserved')")
# cur.execute("insert into roomd values(9,1,'No','Yes','Yes',1000,'Unreserved')")
# cur.execute(
#    "insert into roomd values(10,1,'No','Yes','Yes',1000,'Unreserved')")
# cur.execute(
#    "insert into roomd values(11,1,'No','Yes','Yes',1000,'Unreserved')")
# cur.execute(
#    "insert into roomd values(12,1,'Yes','Yes','Yes',1000,'Unreserved')")
# cur.execute(
#    "insert into roomd values(13,1,'Yes','Yes','Yes',1000,'Unreserved')")
# cur.execute(
#    "insert into roomd values(14,1,'Yes','Yes','Yes',1000,'Unreserved')")
# cur.execute(
#    "insert into roomd values(15,1,'Yes','Yes','Yes',1000,'Unreserved')")
# cur.execute(
#    "insert into roomd values(16,1,'Yes','Yes','Yes',1000,'Unreserved')")
# cur.execute(
#    "insert into roomd values(17,1,'Yes','Yes','Yes',1000,'Unreserved')")
# cur.execute(
#    "insert into roomd values(18,1,'Yes','Yes','Yes',1000,'Unreserved')")
...
# cur.execute("insert into paymentsf values(1,'Rajnish','Chanchal','923569844','rajnish@gmail.com',2,'1','5','2021','11:20:27 PM','Cash','3500')")
...
Label(sroot,text="Rajnish and Shivanshu",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
Label(sroot,text="Shivanshu979@gmail.com",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=270)
...
def mainroot():
	...
	def datetime():
		...
		lblInfo = Label(top_frame,font='helvetica 15',text=localtime,bg='gray89',fg='blue')
		lblInfo.place(x=0,y=40)
	...
	def hotel_status():
		...
		path = "background.jpg"
		img = ImageTk.PhotoImage(Image.open(path))
		label = Label(b_frame,text='Rough',image = img ,height=400,width=1080)
		label.image=img
		label.place(x=0,y=0)
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Made by Rajnish and Shivanshu',fg='black',bg='gray91',font='msserif 8')
		nl.place(x=0,y=310)
		nl.tkraise()
	...
	def staff():
		...
		Label(emp1inf,text="Shivanshu",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
		Label(emp1inf,text="Extention : 025",bg='white',fg="Grey",font='msserif 10').place(x=60,y=59)
		Label(emp1inf,text="Mail : Manager@tajhotel.com",bg='white',fg="Grey",font='msserif 10').place(x=60,y=83)
		emp1inf.pack_propagate(False)
		emp1inf.place(x=117,y=1)

		emp1f = Frame(b_frame)
		path2 = "background.jpg"
		...
		Label(emp1inf,text="Mail : Custexe@tajhotel.com",bg='white',fg="Grey",font='msserif 10').place(x=45,y=83)	
		emp1inf.pack_propagate(False)
		emp1inf.place(x=767,y=2)

		emp1f = Frame(b_frame)
		path3 = "background.jpg"
		...
		Label(emp1inf,text="Mr. Rajnish(Head)",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		Label(emp1inf,text="Extention : 028",bg='white',fg="Grey",font='msserif 10').place(x=72,y=59)
		Label(emp1inf,text="Mail : Restaurant@tajhotel.com",bg='white',fg="Grey",font='msserif 10').place(x=72,y=83)	
		emp1inf.pack_propagate(False)
		emp1inf.place(x=99,y=153)
		emp1inf.tkraise()

		emp1f = Frame(b_frame)
		path4 = "background.jpg"
		...
		Label(emp1inf,text="Mail : Roomsserv@tajhotel.com",bg='white',fg="Grey",font='msserif 10').place(x=55,y=83)	
		emp1inf.pack_propagate(False)
	...
	#cur.execute("create table if not exists paymentsf(id number  primary key,f_name varchar,l_name varchar,c_number varchar,email varchar , r_n number ,day varchar,month varchar,year varchar,time varchar , method varchar)")
		...
		Res = Button(b_frame,text='Reserve',bg='white',fg='cyan4',font='timenewroman 11',activebackground='green',command=reserve).place(x=235,y=270)
	...
	sl_frame = Frame(root,height=800,width=1080,bg='white')
	sl_frame.place(x=0,y=70+6)
	path = "rooms.jpg"
	img = ImageTk.PhotoImage(Image.open(path))
	b1 = Button(sl_frame,image=img,text='b1',bg='white',width=200,height=150,command=rooms)
	b1.image = img
	b1.place(x=180,y=0)
	path2 = "hotelstatus.jpg"
	img1 = ImageTk.PhotoImage(Image.open(path2))
	b2 = Button(sl_frame,image=img1,text='b2',bg='white',width=200,height=150,command=hotel_status)
	b2.image = img1
	b2.place(x=0,y=0)
	path3='contacts.jpg'
	img3 = ImageTk.PhotoImage(Image.open(path3))
	b3 = Button(sl_frame,image=img3,text='b2',bg='white',width=200,height=150,command=staff)
	b3.image = img3
	b3.place(x=180*4,y=0)
	path4='payment.png'
	img4 = ImageTk.PhotoImage(Image.open(path4))
	b4 = Button(sl_frame,image=img4,text='b2',bg='white',width=200,height=150,command = payments)
	b4.image = img4
	b4.place(x=180*3,y=0)
	path5='exit.jpg'
	img5 = ImageTk.PhotoImage(Image.open(path5))
	b5 = Button(sl_frame,image=img5,text='b2',bg='white',width=200,height=150,command=Exit)
	b5.image = img5
	b5.place(x=180*5,y=0)
	path6='reserve.jpg'
	img6 = ImageTk.PhotoImage(Image.open(path6))
	b6 = Button(sl_frame,image=img6,text='b2',bg='white',width=200,height=150,command=reserve)
	b6.image = img6
